...
def test():
	...
	start_base.connect(rest_zone)
	start_base.connect(prio_zone)
	start_base.connect(block_zone)
	rest_zone.connect(end_zone)
	prio_zone.connect(end_zone)
	block_zone.connect(end_zone)
